...
##PmodA                                                                                                        
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { SPI0_SS_O }]; #IO_L6P_T0_35 Sch=JA1_P   
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { SPI0_MOSI_O }]; #IO_L6N_T0_VREF_35 Sch=JA1_N
set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports { SPI0_MISO_I }]; #IO_L18P_T2_AD13P_35 Sch=JA2_P
set_property -dict { PACKAGE_PIN G20   IOSTANDARD LVCMOS33 } [get_ports { SPI0_SCLK_O }]; #IO_L18N_T2_AD13N_35 Sch=JA2_N
